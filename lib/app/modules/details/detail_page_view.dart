...
import 'package:getx_todo_list/app/modules/details/widget/doing_list.dart';
import 'package:getx_todo_list/app/modules/details/widget/done_list.dart';
                  ...
                  suffixIcon: IconButton(
                    onPressed: () {
                      if (homeCtrl.formKey.currentState!.validate()) {
                        var success = homeCtrl.addTodos(homeCtrl.editCtrl.text);
                        if (success) {
